...
class ClothsControllerTest < ActionController::TestCase
  ...
  test "should create cloth" do
    assert_difference('Cloth.count') do
      post :create, cloth: { beacon_identification_key: @cloth.beacon_identification_key, name: @cloth.name, url: @cloth.url, user_id: @cloth.user_id }
    end
  ...
  test "should update cloth" do
    patch :update, id: @cloth, cloth: { beacon_identification_key: @cloth.beacon_identification_key, name: @cloth.name, url: @cloth.url, user_id: @cloth.user_id }
    assert_redirected_to cloth_path(assigns(:cloth))
  end
